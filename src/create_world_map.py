...
# ----------------------------
# Aggregate cumulative stock for a period
# ----------------------------
...
def main(annotations_csv, panel_csv, shapefile, output_png, output_pdf):
    ...
    # Aggregate for two display periods
    agg1 = aggregate_period(cum_df, start_year=2000, end_year=2015)
    agg2 = aggregate_period(cum_df, start_year=2016, end_year=2025)
    ...
    plot_world_map(shapefile, agg1, "Global Active Health-Relevant Documents (2000–2015)", axes[0], cmap, norm)
    plot_world_map(shapefile, agg2, "Global Active Health-Relevant Documents (2016–2025)", axes[1], cmap, norm)
...
if __name__ == "__main__":
    ...
    main(args.annotation, args.panel, args.shapefile, args.output_png, args.output_pdf)